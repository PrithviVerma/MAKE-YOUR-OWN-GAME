...
var zombieWalking,invisibleground,zombieWalkingRight,Bullet,BulletImage;
var gameState = 0;
...
zombieWalkingRight = loadAnimation("sprites/Zombie right/Walk Right(1).png","sprites/Zombie right/Walk Right(2).png","sprites/Zombie right/Walk Right(3).png","sprites/Zombie right/Walk Right(4).png","sprites/Zombie right/Walk Right(5).png","sprites/Zombie right/Walk Right(6).png","sprites/Zombie right/Walk Right(7).png","sprites/Zombie right/Walk Right(8).png","sprites/Zombie right/Walk Right(9).png","sprites/Zombie right/Walk Right(10).png")
BulletImage = loadImage("sprites/Soldier-Guy-PNG/_Weapon/Bullet.png");
}
...
zombie.addAnimation("right",zombieWalkingRight)
Bullet = createSprite(soldier.x,500,10,10);
}
...
if(soldier.x>zombie.x){
     zombie.velocityX=1.5;   
zombie.changeAnimation("right",zombieWalkingRight);
    }
...
function mouseClicked(){
    ...
    Bullet.velocityX = 10;
    Bullet.addImage("Bullet1",BulletImage);
    Bullet.scale = 0.7;
    Bullet.debug = true;
